...
const createMaintenance = async (req, res) => {
  const { asset_id, maintenance_date, maintenance_type, description, cost, technician_id, status } = req.body;
  ...
  try {
    ...
    const result = await pool.query(
      ...
      [uuidv4(), asset_id, maintenance_date, maintenance_type, description, cost, technician_id, status]
    );
...
const updateMaintenance = async (req, res) => {
  ...
  try {
    ...
    const result = await pool.query(
      ...
      [asset_id, maintenance_date, maintenance_type, description, cost, technician_id, status, id]
    );
...
const deleteMaintenance = async (req, res) => {
  ...
  try {
    ...
    const maintenanceResult = await pool.query('SELECT asset_id FROM maintenance_records WHERE id = $1', [id]);
