...
export default function Assets() {
  ...
  const isLoading =
    ...
    suppliersLoading;
  const error =
    assetsError || departmentsError || categoriesError || suppliersError;
    ...
    return (
      <div className="px-4 sm:px-6 md:p-6">
        <Alert>
          ...
          <AlertDescription>
            Fetching assets, departments, categories, and suppliers from the
            server.
          </AlertDescription>
        </Alert>
      </div>
    ...
    return (
      <div className="px-4 sm:px-6 md:p-6">
        <Alert variant="destructive">
          ...
          <AlertDescription>
            {String(error) ||
              "There was a problem loading asset data. Please refresh or try again later."}
          </AlertDescription>
        </Alert>
      </div>
    );
            ...
            <Form {...form}>
              <form
                onSubmit={form.handleSubmit(
                  editingAsset ? handleUpdate : handleCreate,
                )}
                className="space-y-4"
              >
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {categories.find(
                      (c: any) => c.id === selectedAsset.category_id,
                    )?.category_name || "—"}
                  </p>
                </div>
                <div>
                  ...
                  <p className="font-medium">
                    {departments.find(
                      (d: any) => d.id === selectedAsset.department_id,
                    )?.department_name || "—"}
                  </p>
                </div>
                <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {suppliers.find(
                      (s: any) => s.id === selectedAsset.supplier_id,
                    )?.supplier_name || "—"}
                  </p>
                </div>
              </div>
                  ...
                  <td colSpan={8} className="px-4 py-8">
                    <Alert>
                      ...
                      <AlertDescription>
                        ...
                        selections. Try updating your terms or clear the
                        filters.
                      </AlertDescription>
                    </Alert>
                  </td>
              ...
              <tbody>
                {filtered.map((a: any) => {
                  const cat = categories.find(
                    (c: any) => c.id === a.category_id,
                  );
                  const dept = departments.find(
                    (d: any) => d.id === a.department_id,
                  );
                  return (
                    <tr
                      key={a.id}
                    ...
                    >
                      ...
                      <td className="py-3 px-4">
                        <StatusBadge status={a.asset_condition} />
                      </td>
                      <td className="py-3 px-4">
