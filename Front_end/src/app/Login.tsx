...
const Login = () => {
  ...
  const handleProfileClick = async (profile: LoginProfile) => {
    ...
    try {
      ...
      await login({
        email: profile.email,
        password: defaultPasswords[profile.role] || "user123",
      });
        ...
        <div className="login-card">
          ...
          <div className="login-mobile-logo">
            ...
            <div>
              ...
              <div className="login-mobile-tagline">
          ...
          <form onSubmit={handleLogin} className="login-form">
            ...
            <div className="login-field">
              ...
              <Input
                type="email"
                placeholder="ivanzandya@mrrh.go.ug"
                value={email}
          ...
          <p className="login-copyright">
            © 2026 Mbale Regional Referral Hospital Asset Information Management
            System Developed By Ivan
          </p>
        </div>
      </div>
    </div>
